...
Public Class rpt_salesReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DFCPS_MANAGEMENT_SYSTEM.rpt_salesReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_salesReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_salesReport = New rpt_salesReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
