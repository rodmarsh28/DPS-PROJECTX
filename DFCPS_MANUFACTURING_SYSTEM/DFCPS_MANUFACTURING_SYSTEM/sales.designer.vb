...
Partial Public Class InventoryListAllView
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_UNIT_WT", DbType:="Decimal(20,0) NOT NULL")>  _
	Public Property UNIT_WT() As Decimal
		Get
			Return Me._UNIT_WT
		End Get
		Set
			If ((Me._UNIT_WT = value)  _
						= false) Then
				Me._UNIT_WT = value
			End If
		End Set
