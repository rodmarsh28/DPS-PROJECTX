...
Public Class PerCustomerSalesReportTry
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PerCustomerSalesReportTry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPerCustomerSalesReportTry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PerCustomerSalesReportTry = New PerCustomerSalesReportTry()
        rpt.Site = Me.Site
        Return rpt
    End Function
