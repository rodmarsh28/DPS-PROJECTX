...
Public Class OperatorRankingReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "OperatorRankingReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOperatorRankingReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OperatorRankingReport = New OperatorRankingReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
