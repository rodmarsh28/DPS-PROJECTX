...
Public Class YarnProductionReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "YarnProductionReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedYarnProductionReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As YarnProductionReport = New YarnProductionReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
