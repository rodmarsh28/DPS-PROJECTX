...
Public Class loomsDoffedReportAnalytics
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "loomsDoffedReportAnalytics.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedloomsDoffedReportAnalytics
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As loomsDoffedReportAnalytics = New loomsDoffedReportAnalytics()
        rpt.Site = Me.Site
        Return rpt
    End Function
