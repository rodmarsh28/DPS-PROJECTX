...
Public Class doffedYarnReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DFCPS_MANUFACTURING_SYSTEM.doffedYarnReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CacheddoffedYarnReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As doffedYarnReport = New doffedYarnReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
