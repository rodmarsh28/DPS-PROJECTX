...
Public Class circularLoomsReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "circularLoomsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcircularLoomsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As circularLoomsReport = New circularLoomsReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
