...
Public Class doffedYarnReportAnalytics
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "doffedYarnReportAnalytics.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CacheddoffedYarnReportAnalytics
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As doffedYarnReportAnalytics = New doffedYarnReportAnalytics()
        rpt.Site = Me.Site
        Return rpt
    End Function
