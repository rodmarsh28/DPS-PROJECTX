...
Public Class Attendance_Record_Summary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Attendance Record Summary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAttendance_Record_Summary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Attendance_Record_Summary = New Attendance_Record_Summary()
        rpt.Site = Me.Site
        Return rpt
    End Function
