...
Public Class piPremsPayment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DFCPS_MANUFACTURING_SYSTEM.piPremsPayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedpiPremsPayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As piPremsPayment = New piPremsPayment()
        rpt.Site = Me.Site
        Return rpt
    End Function
