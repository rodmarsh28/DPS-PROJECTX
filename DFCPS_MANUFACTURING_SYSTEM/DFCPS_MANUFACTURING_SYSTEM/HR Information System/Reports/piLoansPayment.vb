...
Public Class piLoansPayment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DFCPS_MANUFACTURING_SYSTEM.piLoansPayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedpiLoansPayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As piLoansPayment = New piLoansPayment()
        rpt.Site = Me.Site
        Return rpt
    End Function
