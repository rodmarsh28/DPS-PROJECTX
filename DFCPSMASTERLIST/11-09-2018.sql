...
INSERT INTO [dbo].[tblBenefitsPaymentSum] ([premsID], [payrollID], [empPayrollTransNo], [erSSS], [erPI], [erPH]) VALUES (N'136', N'PR-00002', N'209', N'.0000', N'.0000', N'.0000')
GO

INSERT INTO [dbo].[tblBenefitsPaymentSum] ([premsID], [payrollID], [empPayrollTransNo], [erSSS], [erPI], [erPH]) VALUES (N'137', N'PR-00003', N'210', N'673.0000', N'100.0000', N'137.5000')
GO
...
INSERT INTO [dbo].[tblEmployeesInfo]  VALUES (N'EMP-00004', N'DUMAGO', N'RODMAR', N'', N'GREENVILLE, CALUMPANG, GENERAL SANTOS CITY', N'Single', N'', N'NONE', N'Male', N'1996-06-19 00:00:00.0000000', N'Single', N'IT', N'', N'MIS', N'15000.0000', N'1', N'Monthly', N'2018-08-31 00:00:00.0000000', N'Regular', N'15 Days', N'0940834569', N'', N'121174769816', N'170504061720', N'Yes', N'Updated Last 10/30/2018')
GO
...
INSERT INTO [dbo].[tblEmployeesInfo]  VALUES (N'EMP-00021', N'BIÑAN', N'DEVINE', N'', N'', N'Single', N'', N'', N'Female', N'2018-09-03 00:00:00.0000000', N'Single', N'', N'', N'', N'9500.0000', N'', N'Monthly', N'2018-09-03 00:00:00.0000000', N'Probationary', N'15 Days', N'', N'', N'', N'', N'', N'Updated Last 09/22/2018')
GO
...
INSERT INTO [dbo].[tblEmployeesInfo]  VALUES (N'EMP-00031', N'LAVIÃ‘A', N'LEAH', N'', N'', N'', N'', N'', N'Female', N'2018-09-17 00:00:00.0000000', N'Single', N'', N'', N'OPERATOR', N'311.0000', N'', N'Daily', N'2018-09-17 00:00:00.0000000', N'Probationary', N'15 Days', N'', N'', N'', N'', N'', N'Employees Info Added 09/17/2018')
GO
...
INSERT INTO [dbo].[tblEmployeesInfo]  VALUES (N'EMP-00033', N'FERRAN', N'ZALDY', N'', N'', N'', N'', N'', N'Male', N'2018-10-04 00:00:00.0000000', N'Married', N'', N'', N'OPERATOR', N'54000.0000', N'', N'Monthly', N'2018-09-17 00:00:00.0000000', N'Probationary', N'15 Days', N'', N'', N'', N'', N'No', N'Employees Info Added 10/04/2018')
GO

INSERT INTO [dbo].[tblEmployeesInfo]  VALUES (N'EMP-00034', N'PANGILINAN', N'ARMIN', N'', N'', N'', N'', N'', N'Male', N'2018-10-04 00:00:00.0000000', N'Married', N'', N'', N'OPERATOR', N'45000.0000', N'', N'Monthly', N'2018-09-17 00:00:00.0000000', N'Probationary', N'15 Days', N'', N'', N'', N'', N'No', N'Employees Info Added 10/04/2018')
GO

INSERT INTO [dbo].[tblEmployeesInfo]  VALUES (N'EMP-00035', N'GUMARO', N'NOEL', N'', N'', N'', N'', N'', N'Male', N'2018-10-04 00:00:00.0000000', N'Married', N'', N'', N'OPERATOR', N'42000.0000', N'', N'Monthly', N'2018-09-17 00:00:00.0000000', N'Probationary', N'15 Days', N'', N'', N'', N'', N'No', N'Employees Info Added 10/04/2018')
GO
...
-- ----------------------------
-- Table structure for tblNODA
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[tblNODA]') AND type IN ('U'))
	DROP TABLE [dbo].[tblNODA]
GO

CREATE TABLE [dbo].[tblNODA] (
  [NotdescActionNo] varchar(255) COLLATE Latin1_General_CI_AS  NOT NULL,
  [date] datetime2(7)  NULL,
  [employeeID] varchar(255) COLLATE Latin1_General_CI_AS  NULL,
  [statementOfFact] varchar(255) COLLATE Latin1_General_CI_AS  NULL,
  [applicablePenalty] varchar(255) COLLATE Latin1_General_CI_AS  NULL,
...
ALTER TABLE [dbo].[tblNODA] SET (LOCK_ESCALATION = TABLE)
GO
...
INSERT INTO [dbo].[tblPayroll]  VALUES (N'PR-00002', N'2018-11-09 00:00:00.0000000', N'2018-10-01 00:00:00.0000000', N'2018-10-15 00:00:00.0000000', N'1', N'273.4400', N'4823.4400', N'.0000', N'4823.4400', N'Noroden E. Lacoto', N'Admin')
GO

INSERT INTO [dbo].[tblPayroll]  VALUES (N'PR-00003', N'2018-11-09 00:00:00.0000000', N'2018-10-16 00:00:00.0000000', N'2018-10-31 00:00:00.0000000', N'1', N'164.0600', N'4364.0600', N'564.5000', N'3799.5600', N'Noroden E. Lacoto', N'Admin')
GO
...
CREATE TABLE [dbo].[tblPayrollofEmployees] (
  ...
  [absent] money  NULL,
  [rhd] decimal(18)  NULL,
  [nwhd] decimal(18)  NULL,
  [regHolidays] decimal(18)  NULL,
  [NonWorkHolidays] decimal(18)  NULL,
  [leavePay] money  NULL,
...
-- ----------------------------
-- Table structure for tblSCM
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[tblSCM]') AND type IN ('U'))
	DROP TABLE [dbo].[tblSCM]
GO

CREATE TABLE [dbo].[tblSCM] (
  [SCMNo] varchar(255) COLLATE Latin1_General_CI_AS  NOT NULL,
  [date] datetime2(7)  NULL,
  [employeeID] varchar(255) COLLATE Latin1_General_CI_AS  NULL,
  [desc] varchar(255) COLLATE Latin1_General_CI_AS  NULL,
  [imds] varchar(255) COLLATE Latin1_General_CI_AS  NULL,
  [receivedBy] varchar(255) COLLATE Latin1_General_CI_AS  NULL,
  [notedBy] varchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [hoursValid] int  NULL,
  [status] varchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL
)
GO

ALTER TABLE [dbo].[tblSCM] SET (LOCK_ESCALATION = TABLE)
GO
...
-- ----------------------------
-- Primary Key structure for table tblNODA
-- ----------------------------
ALTER TABLE [dbo].[tblNODA] ADD CONSTRAINT [PK__tblDesci__8E560CD00EA330E9_copy1] PRIMARY KEY CLUSTERED ([NotdescActionNo])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
-- Primary Key structure for table tblSCM
-- ----------------------------
ALTER TABLE [dbo].[tblSCM] ADD CONSTRAINT [PK__tblDesci__8E560CD00EA330E9_copy1_copy1] PRIMARY KEY CLUSTERED ([SCMNo])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
