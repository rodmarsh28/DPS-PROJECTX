...
Public Class payrollTotalSum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DFCPSMASTERLIST.payrollTotalSum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedpayrollTotalSum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As payrollTotalSum = New payrollTotalSum()
        rpt.Site = Me.Site
        Return rpt
    End Function
